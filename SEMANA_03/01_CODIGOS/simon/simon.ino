// frequências para cada som emitido pelo buzzer (peguei pronto)
#define NOTE_B0 31 // representa a nota B na oitava 0 e tem uma frequência de 31 Hertz.
#define NOTE_C1 33
#define NOTE_CS1 35
#define NOTE_D1 37
#define NOTE_DS1 39
...
#define CHOICE_BLUE (1 << 2) // operador de deslocamento (4)
...
#define ROUNDS_TO_WIN 4 // Número de rodadas para vencer o Jogo.
#define ENTRY_TIME_LIMIT 4000 // Tempo para pressionar um botão antes que o jogo acabe

#define MODE_MEMORY 0
byte gameMode = MODE_MEMORY; 
byte gameBoard[32]; // array que alva a combinação de botões à medida que avançamos
...
byte checkButton(void) {
  ...
  else if (digitalRead(BUTTON_RESET) == 0) return(CHOICE_NONE);
  return(CHOICE_NONE);
}
